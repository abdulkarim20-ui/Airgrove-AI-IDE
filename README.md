...
Get started in seconds. The clean, intuitive welcome screen lets you open projects or clone repositories instantly.

<div align="center">
<img src="assets/demos/welcome-screen.png" alt="AirGrove Welcome Screen" width="900" />
<p><em>The AirGrove Welcome Screen - Open Folder, New File, or Clone Repository. Recent workspaces: Mudssr, PlayGround, Finance Dashboard</em></p>
</div>
...
Full Monaco editor with code intelligence, AI reasoning panel, and real-time linting. Edit HTML/CSS and see live preview updates instantly.
...
Build entire projects without leaving AirGrove. See financial dashboards rendered in real-time with all components and data visualization.
...
Choose your AI model based on your needs - from Kimi K2.5 for speed to Nemotron 1208 for advanced reasoning, or GPT-OSS 1208 for privacy.

<div align="center">
<img src="assets/demos/ai-model-selector.png" alt="AI Model Selector" width="600" />
<p><em>Dynamic AI model selection - Switch between different LLM providers seamlessly for optimal performance</em></p>
</div>
